<% if $isLimitedToRestrictedProducts %>
    ...
    <span class="d-inline-block text-blue-dark-85"><%t SilverCart\Voucher.LimitedToRestrictedProductsSingular 'This voucher is valid for the product <i><u>{title}</u></i>.' title=$AffectedShoppingCartPositions.first.Title %></span>
