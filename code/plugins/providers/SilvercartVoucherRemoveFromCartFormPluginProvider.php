 ...
 * @copyright 2011 pixeltricks GmbH
 */
class SilvercartVoucherRemoveFromCartFormPluginProvider extends SilvercartPlugin {
    ...
    /**
     * We give the possibility to update the preferences here.
     * 
     * @param array &$arguments     The arguments to pass
     * @param mixed &$callingObject The calling object
     * 
     ...
     * @since 28.11.2011
     */
    public function updatePreferences(&$arguments = array(), &$callingObject) {
        $this->extend('pluginUpdatePreferences', $arguments, $callingObject);
